...
export default function AdminUsersPage() {
  return <Stub title="Users & Kitchens" sub="Full user directory, kitchen profiles, impersonate / change tier / suspend actions." />;
}
...
function Stub({ title, sub }: { title: string; sub: string }) {
  return (
    <div className="px-4 sm:px-8 lg:px-14 pt-6 lg:pt-12 pb-12 lg:pb-20 max-w-[1000px] mx-auto">
      ...
      <p className="font-serif italic text-lg text-muted mt-3 mb-10">{sub}</p>
