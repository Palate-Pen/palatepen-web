...
const PLANS: Plan[] = [
  {
    ...
    yearlyKey: null,
    who: 'Trying it out',
    features: ['5 recipes · 10 notebook ideas', '1 user · 1 outlet', 'No AI scans', 'Basic costing'],
    cta: 'Current plan',
    locked: true,
  },
  {
    ...
    features: ['Unlimited recipes & notebook', '1 user · 1 outlet', '80 invoice scans/mo', 'AI recipe & spec scanning', 'Stock, menus, allergens, price alerts'],
    cta: 'Upgrade to Pro',
    highlight: true,
  },
  {
    ...
    features: ['Up to 5 users · 1 outlet', '200 invoice scans/mo', 'Team permissions', 'Supplier ordering', 'Waste tracking'],
  ...
  },
  {
    ...
    features: ['Up to 5 outlets · 5 users per outlet', '500 invoice scans/mo', 'Central kitchen', 'Group reporting', 'POS integration', 'Public API access'],
  ...
  },
  {
    ...
    features: ['Unlimited users · unlimited outlets', 'Unlimited invoice scans', 'Custom integrations', 'Dedicated account manager', 'SLA + priority support', 'Custom contract terms'],
    cta: 'Contact sales',
    contactSales: true,
  },
];
