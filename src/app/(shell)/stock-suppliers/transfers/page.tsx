...
export const metadata = { title: 'Stock Transfers — The Walk-in — Palatable' };
    ...
    <div className="px-4 sm:px-8 lg:px-10 pt-6 lg:pt-12 pb-12 lg:pb-20 max-w-[1680px] mx-auto">
      <div className="flex items-start justify-between gap-6 flex-wrap mb-8">
        <div className="flex-1 min-w-[280px]">
          ...
          <p className="font-serif italic text-lg text-muted">
            Move stock between kitchen and bar — same site, or across sites. Drafted here, decremented on send, credited on receive.
          </p>
        </div>
        <Link
          href="/stock-suppliers/transfers/new"
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-rule border border-rule mb-10">
        ...
        <KpiCard
          ...
          sub={inboundAwaiting === 0 ? 'all received' : 'confirm when they arrive'}
        ...
        <div className="bg-card border border-rule">
          ...
          {rows.map((r, i) => {
            ...
            return (
              <Link
                key={r.id}
                href={`/stock-suppliers/transfers/${r.id}`}
                className={
