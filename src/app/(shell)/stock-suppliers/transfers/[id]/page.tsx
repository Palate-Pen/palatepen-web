...
import { TransferLineEditor } from './TransferLineEditor';
import {
  sendTransferAction,
...
export const metadata = { title: 'Stock Transfer — Palatable' };
...
export default async function TransferDetailPage({
  ...
  // Pull source-side ingredients for the picker. We don't filter by pool
  // since pool is a label not a partition — chefs picking from "bar" can
  // still see kitchen items at the same site (real life sometimes blurs).
