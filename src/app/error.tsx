...
/**
 * Root error boundary — last line of defence for any route that
 * doesn't have a closer error.tsx. Reports via the lightweight error
 * reporter (console + optional webhook) and gives the user a quotable
 * request_id for support emails.
 */
    ...
    <html lang="en">
      <body className="bg-paper min-h-screen flex flex-col">
        <header className="px-6 md:px-10 py-8 border-b border-rule">
          <span className="font-display font-semibold text-sm tracking-[0.3em] uppercase text-ink inline-flex items-center gap-1.5">
            Palatable
        ...
        <main className="flex-1 w-full max-w-[680px] mx-auto px-6 md:px-10 py-16 md:py-24 flex flex-col justify-center">
          ...
          <p className="font-serif italic text-lg text-muted mb-10 leading-relaxed">
            Something unexpected blew up on this page. Try again — most of the time it&apos;ll just work the second time.
          </p>
