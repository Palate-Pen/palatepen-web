...
export default function MisePromo() {
        ...
        {s.id === 'hero' && (
          <div style={{ textAlign: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '2px', marginBottom: '24px' }}>
              <span style={{ fontFamily: 'Georgia,serif', fontWeight: 700, fontStyle: 'italic', fontSize: '64px', color: text, letterSpacing: '-3px', lineHeight: '1' }}>M</span>
              <div style={{ width: '12px', height: '12px', borderRadius: '50%', background: gold, marginBottom: '20px', marginLeft: '2px', marginRight: '4px' }}></div>
              <span style={{ fontFamily: 'Georgia,serif', fontWeight: 300, fontSize: '64px', color: text, letterSpacing: '14px', lineHeight: '1' }}>ISE</span>
            </div>
        ...
        {s.id === 'end' && (
          <div style={{ textAlign: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '2px', marginBottom: '20px' }}>
              <span style={{ fontFamily: 'Georgia,serif', fontWeight: 700, fontStyle: 'italic', fontSize: '80px', color: text, letterSpacing: '-4px', lineHeight: '1' }}>M</span>
              <div style={{ width: '14px', height: '14px', borderRadius: '50%', background: gold, marginBottom: '26px', marginLeft: '3px', marginRight: '6px' }}></div>
              <span style={{ fontFamily: 'Georgia,serif', fontWeight: 300, fontSize: '80px', color: text, letterSpacing: '18px', lineHeight: '1' }}>ISE</span>
            </div>
