  ...
  return (
    <div className="flex items-center gap-4 flex-wrap">
      <input
        ...
        onBlur={saveName}
        className="font-serif text-2xl font-normal leading-[1.1] tracking-[-0.015em] text-ink bg-transparent border-b border-rule focus:border-gold focus:outline-none px-1 py-0.5 min-w-[200px]"
        disabled={pending}
      />
