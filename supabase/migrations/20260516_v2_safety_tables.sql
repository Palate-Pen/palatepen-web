...
-- Date: 2026-05-16
-- Applied: 2026-05-16 (via Supabase MCP apply_migration — the earlier
-- "applied via SQL editor" breadcrumb was added prematurely; verified
-- live state was empty and ran the migration from this session).
--
