        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="font-light text-lg text-mise-dim max-w-lg leading-relaxed mb-10">
              Everything a working chef needs — recipe management, cost control, AI invoice scanning, and stock tracking — in one place. On any device.
            </p>
            ...
            <p className="text-xs text-mise-faint mt-4">Also available on iOS and Android — coming soon</p>
          </div>
              ...
              <div className="flex h-72">
                ...
                <div className="w-48 bg-mise-surface2 border-r border-mise-border p-3 flex flex-col gap-1">
                  <div className="flex items-center gap-2 px-3 py-2 mb-3">
                    <span className="font-fraunces font-bold italic text-mise-text text-lg" style={{letterSpacing:'-1px'}}>M</span>
                    <div className="w-1.5 h-1.5 rounded-full bg-mise-gold" style={{marginBottom:'5px'}}></div>
                    <span className="font-fraunces font-light text-mise-text text-lg" style={{letterSpacing:'3px'}}>ISE</span>
                  </div>
                  {[{label:'Recipes',active:true},{label:'Notebook',active:false},{label:'GP Calc',active:false},{label:'Invoices',active:false},{label:'Stock',active:false},{label:'Profile',active:false}].map(item=>(
                    <div key={item.label} className={`flex items-center gap-2 px-3 py-2 rounded text-xs ${item.active?'bg-mise-gold/10 text-mise-gold border border-mise-gold/20':'text-mise-dim'}`}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl">
            ...
            <div className="border border-mise-border p-8">
              ...
              <p className="font-fraunces font-light text-mise-text mb-1" style={{fontSize:'52px'}}>£0<span className="text-xl text-mise-faint">/mo</span></p>
            ...
            <div className="border border-mise-gold/40 bg-mise-gold/5 p-8 relative">
              ...
              <p className="font-fraunces font-light text-mise-text mb-1" style={{fontSize:'52px'}}>£9.99<span className="text-xl text-mise-faint">/mo</span></p>
              <p className="text-sm text-mise-gold mb-8">or £99/year — save 17%</p>
              <div className="space-y-3 mb-8">
